 ...
 */
@Service
public class RedisTemplateService2{

//    @Resource(name = "redisTemplateObject2")
    @Autowired(required = false)
    @Qualifier("redisTemplateObject2")
    private RedisTemplate redisTemplate;




    public RedisTemplateService2 saveKeyVal(String key, String value) {
    ...
    public RedisTemplateService2 saveKeySet(String key, Set<String> set) {
