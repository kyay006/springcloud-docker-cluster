...
public class WXPayConstants {
     ...
     * 公众号、小程序appid
     */
    public static String APP_ID = "wx0b9d4087edc43c12"; // 真实
//    public static String APP_ID_XXX = ""; // 测试/第二个账号

    /**
     * AppSecret
     */
    public static String SECRET = "f53485a7b7042d462d184a114fcd7887"; // 真实
//    public static String SECRET_XXX = ""; // 测试/第二个账号
