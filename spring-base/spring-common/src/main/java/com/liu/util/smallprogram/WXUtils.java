package com.liu.util.smallprogram;
...
//        System.out.println("getMiniBaseUserInfo:params:[{}]" + code);
        String data = restTemplate.getForObject(WXURL.WX_MINI_LOGIN, String.class, appId, appSecret, code);
//        System.out.println("getMiniBaseUserInfo:result:[{}]" + data);
    ...
    public JSONObject getJsapiAccessTokenByCode(String code) {
        ...
        try {
            ...
            String access_token_json = restTemplate.getForObject(WXURL.OAUTH_ACCESS_TOKEN_URL, String.class,
                    WXPayConstants.APP_ID, WXPayConstants.SECRET, code);
            System.out.println("getAccessToken:access_token_json:{}" + access_token_json);
    ...
    public JSONObject getJsapiUserinfo(String access_token, String openid) {
        ...
        try {
            ...
            System.out.println("getUserinfo:userinfo_json:{}" +  userinfo_json);
...
//            }
            ...
            System.out.println("getWxMiniQRImg:fileName:" + newFileName);
...
//            redisTemplate.opsForValue().set(redisKey, imgUrl);
            ...
            System.out.println("getWxMiniQRImg:调用小程序生成微信永久小程序码URL接口异常" + e.getMessage());
        } finally {
            if (inputStream != null) {
                try {
                    inputStream.close();
    ...
    /**
     * 小程序模板信息
     * @param code 获得access_token的code，系统用的appid
     ...
     */
    public void sendTemplateMsg(String code, String touser, String templateId, String page, String formId, JSONObject data, String emphasisKeyword) {
        try {
            ...
            ResponseEntity<byte[]> responseEntity = restTemplate.postForEntity(WXURL.WX_MINI_TEMPLATE_MSG, entity, byte[].class, accessToken);
            System.out.println(new String(responseEntity.getBody()));
        } catch (Exception e) {
            System.out.println("sendTemplateMsg:postForEntity:" + e.getMessage());
        }
    }
    ...
    public byte[] getwxacodeunlimit(String scene, String page) {
        try {
            ...
            // map转换为json传输
            String jsonParam = JSON.toJSONString(param);
            System.out.println("getwxacodeunlimit:param:" + jsonParam);
            ...
            System.out.println("getwxacodeunlimit:postForEntity:" + e.getMessage());
        }
