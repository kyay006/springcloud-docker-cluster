...
public class RedisConfig {
    ...
    @Value("${customConfig.redis.server.port:0}")
    private int port;
    @Value("${customConfig.redis.server.jedis.pool.max-idle:0}")
    private int maxIdl;
    @Value("${customConfig.redis.server.jedis.pool.min-idle:0}")
    private int minIdl;
//    @Value("${customConfig.redis.server.keytimeout}")
//    private long keytimeout;
    @Value("${customConfig.redis.server.timeout:0}")
    private int timeout;
