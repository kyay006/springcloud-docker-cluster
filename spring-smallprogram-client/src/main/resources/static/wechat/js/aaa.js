...
//     // debugger;
//
//     // if($(".frs-author-name-wrap .j_user_card").text().indexOf("一树花开") > -1)
//     // if($(".frs-author-name-wrap .j_user_card").text().indexOf("天已黑咯") > -1)
//     if($(".frs-author-name-wrap .j_user_card").text().indexOf("佛系girl") > -1)
//     {
//         alert("有了");
//         return false;
//     }else{
