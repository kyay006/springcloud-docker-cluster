package project.tool.gen.util;

import common.constant.CommonMap;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("project.system"));
    }
}
