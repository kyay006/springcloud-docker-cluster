...
import common.exception.user.UserPasswordRetryLimitExceedException;
...
public class PasswordService
{
    ...
    {
        return user.getPassword().equals(DigestUtils.md5DigestAsHex(new StringBuilder(50).append(user.getLoginName()).append(newPassword).append(user.getSalt()).toString().getBytes()));
