...
public class DefaultDTXExceptionHandler implements DTXExceptionHandler {
    private static final Logger log = LoggerFactory.getLogger(com.codingapi.txlcn.tc.core.checking.DefaultDTXExceptionHandler.class);
    private static final TxLogger txLogger = TxLogger.newLogger(com.codingapi.txlcn.tc.core.checking.DefaultDTXExceptionHandler.class);
