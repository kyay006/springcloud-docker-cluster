...
public class SocketManager {
    private static final Logger log = LoggerFactory.getLogger(com.codingapi.txlcn.txmsg.netty.bean.SocketManager.class);
    private Map<String, AppInfo> appNames;
    private ScheduledExecutorService executorService;
    private ChannelGroup channels;
    private static com.codingapi.txlcn.txmsg.netty.bean.SocketManager manager = null;
    ...
    public static com.codingapi.txlcn.txmsg.netty.bean.SocketManager getInstance() {
        if (manager == null) {
            Class var0 = com.codingapi.txlcn.txmsg.netty.bean.SocketManager.class;
            synchronized(com.codingapi.txlcn.txmsg.netty.bean.SocketManager.class) {
                if (manager == null) {
                    manager = new com.codingapi.txlcn.txmsg.netty.bean.SocketManager();
                }
            }
        }
